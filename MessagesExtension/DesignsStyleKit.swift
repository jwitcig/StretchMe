...
//  StretchMe
//
//  Created by KtJW on 4/21/20.
//  Copyright © 2020 KTJW. All rights reserved.
//
...
public class DesignsStyleKit : NSObject {
    ...
    @objc dynamic public class func drawGenerateButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 170, height: 63), resizing: ResizingBehavior = .aspectFit, buttonFill: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)) {
        ...
        DesignsStyleKit.drawShapeSymbol(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, buttonFill: buttonFill, buttonText: "Generate New", buttonOpacity: 1, shine: true)
    ...
    @objc dynamic public class func drawInsertButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 170, height: 63), resizing: ResizingBehavior = .aspectFit, buttonFill: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        DesignsStyleKit.drawShapeSymbol(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, buttonFill: buttonFill, buttonText: "Insert Image", buttonOpacity: 1, shine: true)
        context.restoreGState()
    ...
    @objc dynamic public class func drawShapeSymbol(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 173, height: 66), resizing: ResizingBehavior = .aspectFit, buttonFill: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000), buttonText: String = "Button Text", buttonOpacity: CGFloat = 1, shine: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        let textFontAttributes = [
            .font: UIFont(name: "SignPainter-HouseScript", size: 30)!,
    ...
    @objc dynamic public class func drawGenerateButtonDepressed(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 170, height: 63), resizing: ResizingBehavior = .aspectFit, buttonFill: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawInsertButtonDepressed(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 170, height: 63), resizing: ResizingBehavior = .aspectFit, buttonFill: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        DesignsStyleKit.drawShapeSymbol(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, buttonFill: color4, buttonText: "Insert Image", buttonOpacity: 1, shine: true)
        context.restoreGState()
    ...
    @objc dynamic public class func drawInsertButtonDisabled(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 170, height: 63), resizing: ResizingBehavior = .aspectFit, buttonFill: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        DesignsStyleKit.drawShapeSymbol(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, buttonFill: color4, buttonText: "Insert Image", buttonOpacity: 0.45, shine: false)
        context.restoreGState()
    ...
    @objc dynamic public class func drawMainScreenBackground(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 319, height: 250), resizing: ResizingBehavior = .aspectFit, background: UIColor = UIColor(red: 0.357, green: 0.804, blue: 0.455, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 7, height: 291), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawPatternJawnPreview(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 319, height: 250), resizing: ResizingBehavior = .aspectFit, buttonFill: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000), background: UIColor = UIColor(red: 0.357, green: 0.804, blue: 0.455, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawInsertImageBackground(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 319, height: 250), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawPatternJawn2Preview(frame: CGRect = CGRect(x: 0, y: 0, width: 320, height: 250), buttonFill: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Symbol Drawing
        let symbolRect = CGRect(x: frame.minX + 75, y: frame.minY + 18, width: 170, height: 63)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)

        DesignsStyleKit.drawInsertButtonDisabled(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, buttonFill: buttonFill)
        context.restoreGState()
    }
    ...
    @objc(DesignsStyleKitResizingBehavior)
