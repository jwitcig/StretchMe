...
public class StretchStyleKit : NSObject {
    ...
    @objc dynamic public class func drawStretch(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 202, height: 16), resizing: ResizingBehavior = .aspectFit, stretchText: String = "012345678910111213") {
    ...
    @objc dynamic public class func drawStretchText(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 116, height: 133), resizing: ResizingBehavior = .aspectFit, textColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000), stretchText: String = "012345678910111213") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func imageOfStretchText(textColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000), stretchText: String = "012345678910111213") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 116, height: 133), false, 0)
            StretchStyleKit.drawStretchText(textColor: textColor, stretchText: stretchText)

        let imageOfStretchText = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfStretchText
    }




    @objc(StretchStyleKitResizingBehavior)
